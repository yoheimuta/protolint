...
- [Official Style Guide]([https://developers.google.com/protocol-buffers/docs/style](https://protobuf.dev/programming-guides/style/)). This is enabled by default. Basically, these rules can fix the violations by appending `-fix` option.
